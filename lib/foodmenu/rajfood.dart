...
import 'package:zomato/product/rajsearchlist.dart';

import '../product/model.dart';
import '../product/util.dart';

class RFood extends StatefulWidget {
  const RFood({super.key});

  @override
  State<RFood> createState() => _RFoodState();
}

class _RFoodState extends State<RFood> {
