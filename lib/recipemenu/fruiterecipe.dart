...
class Fruiterecipe extends StatefulWidget {
  const Fruiterecipe({super.key});

  @override
  State<Fruiterecipe> createState() => _FruiterecipeState();
}

class _FruiterecipeState extends State<Fruiterecipe> {
