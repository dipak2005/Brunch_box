...
import 'package:zomato/recipeutil/saladutil.dart';

import '../product/model.dart';

class Saladrecipe extends StatefulWidget {
  const Saladrecipe({super.key});

  @override
  State<Saladrecipe> createState() => _SaladrecipeState();
}

class _SaladrecipeState extends State<Saladrecipe> {
