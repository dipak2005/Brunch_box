...
import '../recipeutil/foodutil.dart';

class Food extends StatefulWidget {
  Map<String, dynamic>? map = {};

  Food({Key? key, this.map}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          SizedBox(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                Map<String, dynamic> fl = foodlist[index];
          ...
          SizedBox(
            height: MediaQuery.devicePixelRatioOf(context) * 2.5,
          ),
          Row(
            mainAxisSize: MainAxisSize.min,
            ...
            children: [
              ...
              TextButton(
                  onPressed: () {
                    Navigator.pushNamed(context, "Frrecipe");
                  },
                  child: FittedBox(
                    fit: BoxFit.cover,
                    child: Text(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              itemCount: frlist.length,
              itemBuilder: (context, index) {
                Map<String, dynamic> fr = frlist[index];
